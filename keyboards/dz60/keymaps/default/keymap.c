...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LSFT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_NO,
		KC_LGUI, KC_LALT, KC_LCTL, MO(1), KC_SPC, KC_RSFT, KC_RALT, MO(2), KC_NO, MO(1), KC_RCTL),
